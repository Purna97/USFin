...
public class LCADetailsDto {
	...
	private String endclientaddress;
	private Integer lca_reference;
	private String lcastatus;
	private Integer lcadoc_count;
	private String enclientsatus;
	...
	public Integer getLcadoc_count() {
		return lcadoc_count;
	}
	public void setLcadoc_count(Integer lcadoc_count) {
		this.lcadoc_count = lcadoc_count;
	}
	public String getEnclientsatus() {
		return enclientsatus;
	}
	public void setEnclientsatus(String enclientsatus) {
		this.enclientsatus = enclientsatus;
	}
}
