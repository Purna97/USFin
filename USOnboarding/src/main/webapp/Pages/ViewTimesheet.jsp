						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="/"  id="formid" name="formid" enctype="multipart/form-data">
										...
										<div class="form-group row">
												...
												<%-- <div class="col-md-12 col-sm-12">
													<center><table 
														...
														<thead>
															<tr>
																<th style="text-align: center">Verifier Comments</th>
									...
									<div class="form-group row"  id="comid" style="display: none">
										<label class="col-sm-4 col-form-label">Verifier Comments</label>
										<div class="col-sm-3">
											<textarea id="amgr_com" name="amgr_com" class="form-control" rows="4"></textarea>
										</div>
									</div>
									<div class="form-group row">
									...
									<div class="form-group row">
										...
										<div class="col-sm-3">
											<textarea id="tscomments" name="tscomments" class="form-control" rows="4" column="50"></textarea>
										</div>
									</div>
								</div>
								</div>
									...
									<div class="form-group row" id="update_id">
										<div class="col-sm-9">
											<center>
											<c:if test="${(dept eq 8 && emptype eq 'W2 Admin') || ((dept eq 1 && role == 4)&& (emptype eq 'W2 Admin' || emptype eq 'Admin'))}">
	  ...
	  $.ajax({
 	    ...
 	    success: function(response){
 	    	if(response!=null || response!=""){
 	 	 		...
 	 	 		if(((lgemptype=="W2 Admin" || lgemptype=="Admin") && (role == 4 && dept==1)) || (dept==8)){
...
function getPDF(){
	...
	var timesheetId=$('#timesheetId').val();
	var candidate_id=$('#candidate_id').val();
	   window.location.href="generateInvoicepdf?timesheetId="+timesheetId+"&&candidate_id="+candidate_id+"";
	}else{
			 window.location.href="loginpage";
		}
	});
