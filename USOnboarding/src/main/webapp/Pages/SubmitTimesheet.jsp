...
<!--   <link href="https://www.jqueryscript.net/css/jquerysctipttop.css" rel="stylesheet" type="text/css"> -->
 <!--   <link rel="stylesheet" href="resources/js/dist/css/timepicker.min.css"> -->
                      ...
                      <div class="row">
                                  <div class="col">
										...
										<div class="form-group row">
											...
											<div class="col-sm-4">
												<select name="work_auth" autoComplete="off"
													class="form-control text-left" id="work_auth" required
                           ...
                           <div class="row" id="tDetails">
                                  <div class="col">
                                         <div class="card">
                                                <h5 class="card-header" >Pending Timesheet</h5>
                                                <div class="card-body">
                                                       <div class="row">
                                                              <div class="col-lg-12">
                                                                     <input type="hidden" name="emptype" id="emptype"  value="${emptype}">
                                                                      <input type="hidden" name="role" id="role" value="${role}"> 
                                                                          ...
                                                                          <input type="hidden" name="prid" id="prid" value="${timesheetDto.payrateid}">
                                                                           ...
                                                                           <center><h3>Either Payroll type missing or there is no active client/In-house project not added , Please contact to your employer!</h3></center>
                                                                           </c:when>
                                                                           ...
                                                                           <c:if test="${timesheetDto.payrollType eq 'Weekly'}">
                                                                                  <c:forEach var="reportlist" items="${timesheetDto.timesheetList}">
                                                                                         <tr><!-- toprecord -->
                                                                                          <td >${timesheetDto.customer_name}</td>
       ...
       <div class="modal fade" id="statusmodal" tabindex="-1"
                                  ...
                                  <div class="modal-dialog modal-lg" style="max-width:79%" role="document">
                                         <div class="modal-content">
                                                ...
                                                <div class="modal-body timeClass">
...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/tempusdominus-bootstrap-4/5.0.1/js/tempusdominus-bootstrap-4.min.js"></script> -->
 <!--  <script src="resources/js/dist/js/timepicker.min.js"></script> -->
<!--    <script src="resources/js/dist/js/nbtimepicker.min.js"></script> -->
...
<script>
          ...
          success: function(response){
             if(response!=null || response!=""){
              ...
              $.each(response, function(i, item) {
                    ...
                    /*  $('#billablehrs'+i).timepicker({
                    	 defaultTime: '8',
                     });
                      $('#nonbillablehrs'+i).timepicker({
                    	  defaultTime: '0',
                      });
                      $('#over_time'+i).timepicker({
                    	  defaultTime: '0',
                      }); */
                    /*   $('#datetimepickernon'+i).datetimepicker({
                      ...
                      /*  $( ".timeClass1" ).click(function() {
                    	   alert("hi");
                    	   $('#datetimepicker'+i).data("DateTimePicker").toggle();
                       }); 
                       
                       $('#datetimepicker'+i).click(function() {
                    	   $('#datetimepicker'+i).data("DateTimePicker").hide();
                    	});*/
          ...
          if(row!=0){
	    	    date = $(tr).find('td:eq(0)').text()
 				...
 				$(tr).find('td:eq(6) textarea').attr("placeholder", "Enter Comments").css( "border-color", "red" ).focus();
     				...
     				if(hrs!=""){
     					fhrs=parseInt(hrs*60)+parseInt(billhrs.substring(3, 5));	
     				}else{
     					fhrs="";
     				}
     				//alert(fhrs);
	    	    ...
	    	    if((fhrs>480) && (nonbillhrs!="" || nonbillhrs!="00:00") && comments!=""){
	    	    	$(tr).find('td:eq(6) textarea').attr("placeholder", "Enter Comments").css( "border-color", "red" ).focus();
	          		 billablerowvalue=false; arraybillable.push(billablerowvalue);
	          		rowvalue=false; array.push(rowvalue);
	     	           		} 
     		   if((fhrs>0 && fhrs<480) && comments==""){
     		 	$(tr).find('td:eq(6) textarea').attr("placeholder", "Enter Comments").css( "border-color", "red" ).focus();
     			billablerowvalue=false;	arraybillable.push(billablerowvalue);
     			commentvalue=false;	arraycomment.push(commentvalue);
	           		} 
  ...
  if(arraybillablecheck.includes(false)){
	  ...
	  if(lgemptype=="W2 Admin" || lgemptype=="Admin"){
          if(arrayleave.includes(false) && leavefilename==""){
        	  if( leavefilename==""){
...
/* var clistsize= $('#payrateclientListsize').val();
if(parseInt(clistsize)>1){
	 $("#tDetails").hide();
} */
