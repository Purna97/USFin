...
<body>
		...
		<div class="content">
			...
			<div class="animated fadeIn">
				<div class="row">
					<div class="col">
						<div class="card">
							<h5 class="card-header">Search Report</h5>
							<div class="card-body">
								<div class="row">
									<div class="col-lg-12">
											   ...
											   var myDate = new Date();
												...
												document.write('<option value="'+i+'">'+ i+ '</option>');
											     ...
											     <select name="customertype" autoComplete="off" class="form-control text-left" id="customertype" >
										             ...
										             <c:forEach var="plist" items="${cutomerList}">
										             <c:choose>
													<c:when test="${not empty plist.custname}">
													<option value="${plist.payrate_id}" ${plist.payrate_id eq customertype ? 'selected="selected"' : ''}>
													${plist.custname}
													</option>
													</c:when>
													<c:otherwise>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="card">
									<h5 class="card-header" style="padding: .2rem;">View Status Report
										Details</h5>
									<div class="card-body">
						...
						<form action="/" id="formidmodal">
							<div class="row">
								<div class="col-md-10 col-sm-12">
									...
									</c:if> --%><%-- <jsp:useBean id="date" class="java.util.Date" />
	...
	<form action="getreports" method="post" id="vformid" >
...
function updateStatus(){
	getsesVal().done(function(data){
		if(data!=""){
	$('#formidmodal').formValidation('validate');
	if (!$('#formidmodal').data('formValidation').isValid()) {
		//alert("not Valid");
	} else {
	$("#submitid,#updateid").attr("disabled",true);
		...
		$.ajax({
	            url: "updatestatusreport", //this is the submit URL
	            type: "POST",
...
$('#statusmodal').on('hide.bs.modal', function(){
	  document.getElementById("formidmodal").reset();
	$('#formidmodal').bootstrapValidator('resetForm', true);
});
$('#formidmodal').formValidation({
	    framework: 'bootstrap',
	    row: {
	        valid: 'field-success',
	        invalid: 'field-error'
